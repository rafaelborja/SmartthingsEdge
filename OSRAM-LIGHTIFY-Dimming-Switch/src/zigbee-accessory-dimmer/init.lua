...
--       },
      [Level.ID] = {
        -- [Level.server.commands.Move.ID] = level_move_command_handler, -- 0x01 not used
        -- # [Level.server.commands.Step.ID] = level_step_command_handler -- 0x02 not used
        [Level.server.commands.MoveWithOnOff.ID] = on_off_command_handler, -- level_move_with_onoff_command_handler, -- 0x06 handleButtonPress
        [Level.server.commands.MoveToLevelWithOnOff.ID] = on_off_command_handler -- level_move_to_level_with_onoff_command_handler, -- 0x08 handleButtonHeld
      },
      [Scenes.ID] = {
